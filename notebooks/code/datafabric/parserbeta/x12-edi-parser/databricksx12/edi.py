...
class EDI():
    ...
    def __init__(self, data, delim_cls = None, strict_transactions=True):
        ...
        self.authorization_information_qualifier = self.isa.element(1)  
        self.authorization_information = self.isa.element(2)            
        self.security_information_qualifier = self.isa.element(3)       
        self.security_information = self.isa.element(4)                 
        self.interchange_id_qualifier_1 = self.isa.element(5)           
        self.interchange_sender_id = self.isa.element(6)                
        self.interchange_id_qualifier_2 = self.isa.element(7)           
        self.interchange_receiver_id = self.isa.element(8)              
        self.interchange_date = self.isa.element(9)                     
        self.interchange_time = self.isa.element(10)                    
        self.repetition_separator = self.isa.element(11)                
        self.interchange_control_version_number = self.isa.element(12)  
        self.interchange_control_number = self.isa.element(13)          
        self.acknowledgement_requested = self.isa.element(14)           
        self.usage_indicator = self.isa.element(15)                     
        self.component_element_separator = self.isa.element(16)         
